...
public class AuthenticationController {
	...
	public ResponseEntity<String> reset(HttpServletRequest request, @RequestBody UserEntity param) throws Exception {
		UserEntity entity = userImpl.findByUsernameActiveAndBranch(param.getUsername(), "");
		entity.setPassword(param.getPassword());
		userImpl.save(entity, "");
		return ResponseEntity.ok("berhasil reset");
	}
}
